      ...
      <div className="max-w-7xl px-2 mx-auto">
        ...
        <h2 className="text-2xl lg:text-4xl xl:text-[2.4rem] max-w-7xl font-bold text-gray-800 !leading-[1.3] mb-2">
          ...
          <span className="text-red-600 font-bold">
            {content.sections[1].title?.split("||")[1]}
          </span>
        </h2>
          ...
          {content?.Cards &&
            content?.Cards?.map((uni, index) => (
              ...
              >
                ...
                <div
                  className={`absolute inset-0  bg-gradient-to-br from-[#C9A84C]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl pointer-events-none`}
                />
                ...
                <div className="bg-gradient-to-br from-pink-50 to-amber-50 border border-gray-200 rounded-2xl overflow-hidden">
                  <div className="px-6 py-4 bg-red-600 text-white">
                    <h3 className="font-bold text-lg flex items-center gap-2">
                      <DynamicIcon
                        name={item?.iconitem || "GraduationCap"}
                        size={20}
                        color="#fff"
                      />
                      {item?.tableTitle}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-base max-w-2xl mx-auto">
            Scroll down to explore different intake options. Cards will stack
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden border-2 border-gray-100">
        ...
        <div className={`bg-gradient-to-r ${intake.color} p-6 pb-8`}>
          <div className="flex items-center justify-between mb-3">
            <span
              className={`${intake.badgeColor} text-white font-bold text-xs px-4 py-1.5 rounded-full tracking-wide shadow-lg flex items-center gap-2`}
            >
  ...
  return (
    <section className="bg-[#F8F6F2] py-12 px-5">
      <div className="max-w-7xl mx-auto">
        ...
        <div
          className={`grid gap-6 lg:gap-8 mb-12 ${getGridClass(content?.sections[4]?.content?.intakecards?.length)}`}
        >
          <IntakeCard content={content} />
        </div>
