...
function Index({
  ...
  const processSteps = [
    {
      ...
      description:
        "We assess your academic background, IELTS score (or MOI eligibility), budget, preferred course, and career goals. You receive a personalised Destination university shortlist — within 48 hours, completely free.",
      icon: "📋",
      color: "bg-red-500",
    },
    {
      ...
      description:
        "Our certified IELTS coaches help you achieve your target band score with a personalised study plan, weekly mock tests, and focused speaking and writing practice sessions.",
      icon: "📚",
      color: "bg-orange-500",
    },
    {
      ...
      description:
        "Our UK-experienced writers craft a compelling Statement of Purpose, guide your referees on LOR content, and prepare your complete application package tailored to each university's requirements.",
      icon: "📝",
      color: "bg-amber-500",
    },

    {
      ...
      description:
        "We identify every scholarship you're eligible for and complete those applications. We also assist with education loan documentation for SBI, HDFC Credila, Axis, and other lenders — ensuring you get the best rate.",
      icon: "💰",
      color: "bg-green-500",
    },
    {
    ...
    },
    {
      ...
      description:
        "Accommodation guidance, forex cards, NHS registration,bank account tips, transport orientation, and connections to Indian student communities at your university — we're with you even after you land.",
      icon: "✈️",
      color: "bg-purple-500",
    },
  ];
  ...
  return (
    <>
      <HeroSection
        content={homePageDetails?.sections[0]?.content}
        title={homePageDetails?.sections[0]?.content?.title}
        description={homePageDetails?.sections[0]?.content?.subtitle}
        image={`${baseUrl}/uploads/${homePageDetails?.pageContent?.heroImage}`}
      />

      {/* Student Info Section - AUTO HEIGHT */}
      <section className=" relative bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 l lg:py-12 lg:px-8">
          <div className=" flex flex-col lg:flex-row items-center juftify-center gap-8 md:gap-12">
                        ...
                        <div key={index} className="keen-slider__slide w-full">
                          <div className="relative flex flex-col items-center w-full">
                            <div className="relative w-full flex justify-center">
                              <div className="relative w-full max-w-[220px] sm:max-w-[260px] md:max-w-[300px] lg:max-w-full">
                                <Image
      ...
      <section
        id="exams"
        className="relative py-16 md:py-12 bg-white overflow-hidden "
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
            {homePageDetails?.sections[3]?.content?.testprepcourses?.map(
              (exam, idx): any => {
                const colorbgClass =
                  exam?.coursetitle === "IELTS"
                    ? "bg-red-500"
                    : exam?.coursetitle === "PTE"
                      ? "bg-cyan-500"
                      : exam?.coursetitle === "TOEFL"
                        ? "bg-blue-800"
                        : exam?.coursetitle === "GRE"
                          ? "bg-[#0C447C]"
                          : exam?.coursetitle === "GMAT"
                            ? "bg-cyan-600"
                            : exam?.coursetitle === "SAT"
                              ? "bg-cyan-400"
                              : exam?.coursetitle === "Duolingo"
                                ? "bg-[#76c442]"
                                : "bg-gray-500";
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`absolute top-0 left-0 right-0 h-1 ${colorbgClass}  rounded-t-2xl opacity-0 group-hover:opacity-100 transition-opacity`}
                    />
                    ...
                    {/* Exam Name & Details */}
                    <h3
                      className={`text-2xl lg:text-4xl font-bold ${colorClass} mb-1`}
                    >
                      {exam.coursetitle}
                    </h3>
                    <p
          ...
          <div className="mt-10 flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 text-center">
            <p className="text-black text-xm md:text-base">
              ...
              Our experts will guide you to the right exam for your target
              country & university.
            </p>
            <button
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(188, 140, 252, 0.2), rgba(215, 22, 53, 0.2))",
        }}
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 md:mb-12">
            ...
            <h2 className=" text-2xl sm:text-3xl md:text-4xl font-black text-gray-900 leading-tight mb-3 font-bold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 p-0 md:p-6">
            {homePageDetails.sections[4]?.content?.abroadconsulting?.map(
              (service, index) => {
                return (
                  <div
                    key={index}
            ...
            {/* Card 2: Test Prep */}
            {homePageDetails.sections[4]?.content?.testprepcourses?.map(
              (course, index) => {
                return (
                  <div
                    key={index}
      ...
      <StudentScoresSection
        content={homePageDetails?.sections[7]?.content}
        studentslider={slider}
      />
      ...
      <section className="bg-red-50 py-12 md:py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-10 md:mb-14">
            ...
            {/* Main Heading */}
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#C41430] leading-tight  mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-14">
            {homePageDetails?.sections[9]?.content?.cities?.map(
                  ...
                  <Link key={index} href={`/${loc?.slug}`}>
                    <div
                      className={`
                        ...
                        ${
                          index ===
                          homePageDetails?.sections[9]?.content?.cities
                            ?.length -
                            1
                    ...
                    >
                      <div
                        className={`mb-3 ${index === homePageDetails?.sections[9]?.content?.cities?.length - 1 ? "text-white" : "text-[#C41430]"}`}
                      >
            ...
            <div className="w-full lg:w-[67%]">
              ...
              <div className="mb-8">
                <h2 className="text-2xl lg:text-4xl max-w-3xl font-bold text-gray-800 !leading-[1.3] mb-4">
                  {highlightText(
                    "How Gateway Abroad Helps || To Achieve Your Dream Destination || — End to End",
                  )}
                </h2>

                <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                  From your first free consultation to your flight to the
                  Destination — we manage every step with precision and care.
                </p>
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          {/* Title */}
                          <h3
                            className={`font-bold text-base lg:text-lg mb-2 transition-colors duration-300 ${
                              isActive
                                ? "text-gray-900"
      ...
      <section className="py-12 bg-gray-300 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="mb-10 sm:mb-12 lg:mb-16">
            ...
            <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight">
          ...
          testimonials.testimonial.length === 0 ? (
      ...
      <section className="py-12 md:py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center ">
            ...
            <Link
              href="/blog"
              className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors duration-300 transform hover:scale-105 shadow-lg flex items-center gap-2"
            >
              View All Blogs
      ...
      <FAQSection
        content={homePageDetails?.sections[11]?.content}
        faq={faqdata}
      />
        ...
        <div className="modal-box max-w-4xl">
          ...
          <div className="modal-body max-h-[70vh] px-2 overflow-y-auto">
            <div className="get-in-touch-form">
              <form
                onSubmit={handleSubmitPartner(handleUpdate2)}
                className="space-y-4"
              >
                ...
                <div>
                  ...
                  >
                    <option value="">
                      did you come to know about Gateway Abroad?
                    </option>
                ...
                <div>
                  <textarea
                    {...registerPartner("qualifications", {
