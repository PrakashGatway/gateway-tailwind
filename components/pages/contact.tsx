...
function Contact({
  ...
  const nationalOffices = officeData.filter(
    (office) => office.officeType === "National",
  );
  const internationalOffices = officeData.filter(
    (office) => office.officeType === "InterNational",
  );
            ...
            <div className="lg:w-1/2">
              <div className="text-center lg:text-left">
                ...
                <p className="text-gray-600  leading-relaxed">
                  {pageTitle ||
                    `No matter what's bothering you, Our experienced counsellors of the top study abroad destinations are here to solve your every doubt regarding studying abroad. Call us at any time or stop by one of our branches to see us.`}
                </p>
              </div>
            </div>
            <div className="lg:w-1/2">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-4xl mx-auto">
              {description ||
                `We believe in being the best ally to our students. When we say, "quality education is a right and not a luxury," we mean it in every sense. No matter what's bothering you, Our experienced counsellors of the top study abroad destinations are here to solve your every doubt regarding studying abroad. Call us at any time or stop by one of our branches to see us.`}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-16">
            ...
            <div className="bg-white rounded-lg font-bold  p-6 text-center border border-[#bdbdbd]">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-4 text-red-600">
                Call Us:
              </h4>
              <div className="space-y-2">
                <h5 className="text-gray-700">
                  <a
                    href={`tel:${contact.contectOne}`}
            ...
            <div className="lg:w-3/4">
              <div className="text-center lg:text-left">
                ...
                <p className="text-gray-600 mb-8">
                  Please fill the below form to schedule a one to one
                  counselling session
                  <br />
                  with our experts.
                </p>
