...
export default function AllBlogs({ initialData, searchParams }: any) {
  ...
  const [searchQuery, setSearchQuery] = useState(initialData?.searchQuery || searchParam);
  const [debouncedSearchQuery, setDebouncedSearchQuery] = useState(initialData?.searchQuery || searchParam);
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="relative mb-8">
            <div className="relative">
              ...
              <div
                ref={scrollRef}
                className="flex space-x-2 overflow-x-hidden py-2 mx-10"
