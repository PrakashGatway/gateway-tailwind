...
export default function TestPrepForm() {
  ...
  const OptionCard = ({ 
    ...
    return (
      ...
      >
        ...
        <span className="text-sm font-medium flex-1 text-black">{label}</span>
        {isSelected && (
  ...
  const Step2Exam = () => (
    <motion.div  className="space-y-6">
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium text-gray-700">Which exam? <span className="text-red-500">*</span></label>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-1">
          <label className="text-sm font-medium text-gray-700">Target Score</label>
        ...
        <div className="space-y-1">
          <label className="text-sm font-medium text-gray-700">Attempts Taken</label>
        ...
        {hasTakenTest && (
          <motion.div  className="overflow-hidden">
             <div className="space-y-1 p-4 bg-gray-100 rounded-lg border border-gray/20">
                <label className="text-sm font-medium text-[#0d7a6b]">Previous Score (if any)</label>
  ...
  const Step3Level = () => (
    <motion.div className="space-y-6">
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium text-gray-700">Self-Assessed English Level</label>
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium text-gray-700">Weak Areas (Optional)</label>
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {WEAK_AREAS.map((w) => (
  ...
  const Step4Review = () => {
    ...
    return (
      <motion.div className="space-y-6">
        ...
        <div className="bg-[#f0faf7] border border-[#0d7a6b]/20 rounded-lg p-4 text-sm space-y-2 text-gray-700">
  ...
  const SuccessScreen = () => (
    <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="text-center py-8">
      ...
      <button 
        ...
        className="text-sm text-gray-400 underline hover:text-[#0d7a6b]"
      >
    ...
    <FormProvider {...methods}>
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-2xl mx-auto  rounded-2xl shadow-xl  overflow-hidden border border-gray-100  my-10">
        ...
        <div className="bg-red-500 p-6 sm:p-8 text-white ">
          ...
          <p className="text-white/70 text-sm">GRE · GMAT · IELTS · SAT · PTE · TOEFL</p>
        ...
        {currentStep <= 4 && (
          <div className="px-6 sm:px-8 py-4 border-t border-gray-100 flex justify-between items-center bg-gray-50">
            {currentStep > 1 ? (
              <button type="button" onClick={onPrev} className="px-6 py-2 rounded-full border border-gray-300 text-gray-600 text-sm font-medium hover:border-[#0a2240] hover:text-[#0a2240] transition-colors">
                Back
              </button>
            ) : <div />}
            
            {currentStep < 4 ? (
              <button type="button" onClick={onNext} className="px-8 py-2 rounded-full bg-red-500 text-white text-sm font-bold hover:bg-red-500 transition-all flex items-center gap-2 shadow-lg shadow-[#0d7a6b]/20">
                Next <ChevronRight size={16} />
              </button>
            ) : (
              <button type="submit" disabled={isSubmitting} className="px-8 py-2 rounded-full bg-red-500 text-[#1a1000] text-sm font-bold hover:bg-[#d4901a] transition-all flex items-center gap-2 shadow-lg shadow-[#e8a020]/20 disabled:opacity-70">
