  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdowns: cn(
          'w-full flex items-center text-xm font-medium justify-center h-[--cell-size] gap-1.5',
        ...
        caption_label: cn(
          ...
          captionLayout === 'label'
            ? 'text-xm'
            : 'rounded-md pl-2 pr-1 flex items-center gap-1 text-xm h-8 [&>svg]:text-muted-foreground [&>svg]:size-3.5',
